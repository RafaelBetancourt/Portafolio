...
function Projects() {
    ...
    return (
        <div className='h-[70vh] pt-0 mt-40  '>
            ...
            <div className='flex flex-row h-[50vh] w-full pt-20 pb-10 '>
                <div className="relative mx-3 ml-10">
                    <a href="https://pf-app-five.vercel.app/" target="_blank" className="absolute inset-0 z-10 bg-green-outer-light text-center flex flex-col h-[90%] items-center rounded-lg justify-center opacity-0 hover:opacity-100 bg-opacity-90 duration-500">
                ...
                <div className="relative mx-3 ml-10">
                    <a href="https://github.com/RafaelBetancourt/P.I---COUNTRIES" target="_blank" className="absolute inset-0 z-10 bg-green-outer-light text-center flex flex-col h-[92%] items-center rounded-lg justify-center opacity-0 hover:opacity-100 bg-opacity-90 duration-500">
                ...
                <div className="relative mx-4 ml-10">
                    <a href="https://github.com/RafaelBetancourt/Weather-App" target="_blank" className="absolute inset-0 z-10 bg-green-outer-light text-center flex flex-col h-[92%] items-center rounded-lg justify-center opacity-0 hover:opacity-100 bg-opacity-90 duration-500">
