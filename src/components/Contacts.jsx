...
function Contacts() {
  ...
  return (
    ...
    <div className='relative flex flex-row justify-between  bg-[#00000052] h-[76vh]'>

      <div className='w-100 h-[56vh] pt-14 flex justify-center items-center flex-col relative '>

        <form ref={form} onSubmit={sendEmail} className="flex flex-col justify-center items-center pt-20 w-[54vw] h-[50vh] ">

          <h1 className='w-full ml-[16.5%] text-orange-600 text-4xl pt-20 flex flex-col '>Contactame</h1>
          ...
          <div className='pt-5 mx-auto'>
            ...
            <div className='w-full flex justify-center pt-8'>
              <input className=" py-3 px-10 mt-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-gray-200 rounded-lg border border-gray-900 hover:bg-gray-900 hover:text-orange-600 focus:z-10 focus:ring-4 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-gray-900 dark:hover:bg-gray-700 "
                type="submit"
                value="Enviar"
              />
            </div>
      ...
      <div className='w-100 h-[67.5vh] flex justify-center items-center flex-col relative '>

        <h1 className='w-full  text-orange-600 text-4xl pt-0 flex flex-col '>Tambien puedes comunicarte por:</h1>
